                                    ...
                                    return <TabPane key={index} tab={
                                        <div
                                            ...
                                            <div style={{
                                                ...
                                                <img style={{ objectFit: 'fill', borderRadius: 5 }} className='w-full h-full' src={`${DOMAIN_STATIC_FILE}${rap.logo}`} alt={`${DOMAIN_STATIC_FILE}${rap.logo}`} />
                                            </div>
                                            <div className='flex flex-col items-start flex-wrap ml-2 '>
                                                ...
                                                <p className='text-sm m-0 text-gray-400'>{_.truncate(rap.address, { length: 50, separator: '.' })}</p>
                                            </div>
                                        </div>
                                    }>
